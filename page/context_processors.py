...
def navbarmain(request):
    from page.models import Forcegraph  # Node-Link Visualization querying the page title to show in Navbar
    ...
    from page.models import Timelinegraph  # Timeline Visualization querying the page title to show in Navbar
