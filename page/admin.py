...
from .models import Repository, Forcegraph, Property, Timelinegraph
...
class ForcegraphAdmin(admin.ModelAdmin):
    ...
    search_fields = ['page_title', 'domain_subject', 'result']
# ==========end customizing for Node-link configuration


# ==========start customizing for Timeline configuration
...
class TimelinegraphAdmin(admin.ModelAdmin):
    ...
    list_display = ('page_title', 'created_date', 'updated_date', 'was_published_last', 'date_marked')
    ordering = ['updated_date']
    list_filter = ['published_date']
    search_fields = ['page_title', 'domain_subject', 'result']
# ==========end customizing for Timeline configuration
